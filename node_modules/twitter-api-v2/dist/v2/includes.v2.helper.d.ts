import type { ApiV2Includes, ListV2, SpaceV2, TweetV2, UserV2 } from 'twitter-api-v2/dist/types';
...
export declare class TwitterV2IncludesHelper implements ApiV2Includes {
    ...
    get media(): import("twitter-api-v2/dist/types").MediaObjectV2[];
    static media(result: TTwitterV2IncludesResult): import("twitter-api-v2/dist/types").MediaObjectV2[];
    /** Medias associated with the given tweet (*`attachments.media_keys`*) */
    medias(tweet: TweetV2): import("twitter-api-v2/dist/types").MediaObjectV2[];
    /** Medias associated with the given tweet (*`attachments.media_keys`*) */
    static medias(result: TTwitterV2IncludesResult, tweet: TweetV2): import("twitter-api-v2/dist/types").MediaObjectV2[];
    get polls(): import("twitter-api-v2/dist/types").PollV2[];
    static polls(result: TTwitterV2IncludesResult): import("twitter-api-v2/dist/types").PollV2[];
    /** Poll associated with the given tweet (*`attachments.poll_ids`*) */
    poll(tweet: TweetV2): import("twitter-api-v2/dist/types").PollV2 | undefined;
    /** Poll associated with the given tweet (*`attachments.poll_ids`*) */
    static poll(result: TTwitterV2IncludesResult, tweet: TweetV2): import("twitter-api-v2/dist/types").PollV2 | undefined;
    get places(): import("twitter-api-v2/dist/types").PlaceV2[];
    static places(result: TTwitterV2IncludesResult): import("twitter-api-v2/dist/types").PlaceV2[];
    /** Place associated with the given tweet (*`geo.place_id`*) */
    place(tweet: TweetV2): import("twitter-api-v2/dist/types").PlaceV2 | undefined;
    /** Place associated with the given tweet (*`geo.place_id`*) */
    static place(result: TTwitterV2IncludesResult, tweet: TweetV2): import("twitter-api-v2/dist/types").PlaceV2 | undefined;
