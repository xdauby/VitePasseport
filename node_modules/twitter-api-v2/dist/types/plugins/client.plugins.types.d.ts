...
import type { IGetHttpRequestArgs } from 'twitter-api-v2/dist/types/request-maker.mixin.types';
import type { TwitterResponse } from 'twitter-api-v2/dist/types/responses.types';
import type { IComputedHttpRequestArgs } from 'twitter-api-v2/dist/types/request-maker.mixin.types';
import type { IOAuth2RequestTokenResult, RequestTokenResult } from 'twitter-api-v2/dist/types/auth.types';
import type { PromiseOrType } from 'twitter-api-v2/dist/types/shared.types';
import type { ApiResponseError, ApiRequestError, ApiPartialResponseError } from 'twitter-api-v2/dist/types/errors.types';
import type { ClientRequestMaker } from 'twitter-api-v2/dist/client-mixins/request-maker.mixin';
