import type { CashtagEntity, HashtagEntity, MentionEntity, UrlEntity } from 'twitter-api-v2/dist/types/entities.types';
import type { ApiV2Includes } from 'twitter-api-v2/dist/types/v2/tweet.definition.v2';
import type { DataAndIncludeV2, DataMetaAndIncludeV2, DataV2 } from 'twitter-api-v2/dist/types/v2/shared.v2.types';
import type { TTweetv2MediaField, TTweetv2PlaceField, TTweetv2PollField, TTweetv2TweetField, TTweetv2UserField } from 'twitter-api-v2/dist/types/v2/tweet.v2.types';
import type { TypeOrArrayOf } from 'twitter-api-v2/dist/types/shared.types';
