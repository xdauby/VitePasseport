import type { GetDmListV1Args, ReceivedDMEventsV1, TReceivedDMEvent, TwitterResponse, ReceivedWelcomeDMCreateEventV1, WelcomeDirectMessageListV1Result } from 'twitter-api-v2/dist/types';
import { CursoredV1Paginator } from 'twitter-api-v2/dist/paginators/paginator.v1';
export declare class DmEventsV1Paginator extends CursoredV1Paginator<ReceivedDMEventsV1, GetDmListV1Args, TReceivedDMEvent> {
    ...
    protected getItemArray(): import("twitter-api-v2/dist/types").DirectMessageCreateV1[];
    /**
     * Events returned by paginator.
     */
    get events(): import("twitter-api-v2/dist/types").DirectMessageCreateV1[];
}
