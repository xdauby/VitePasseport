import type { TwitterResponse } from 'twitter-api-v2/dist/types';
import type { DataMetaAndIncludeV2 } from 'twitter-api-v2/dist/types/v2/shared.v2.types';
import { TwitterV2IncludesHelper } from 'twitter-api-v2/dist/v2/includes.v2.helper';
import { PreviousableTwitterPaginator } from 'twitter-api-v2/dist/paginators/TwitterPaginator';
...
export declare abstract class TwitterV2Paginator<TResult extends DataMetaAndIncludeV2<any, any, any>, TParams extends object, TItem, TShared = any> extends PreviousableTwitterPaginator<TResult, TParams, TItem, TShared> {
    ...
    get errors(): import("twitter-api-v2/dist/types").InlineErrorV2[];
