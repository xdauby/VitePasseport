import type { IClientSettings, ITwitterApiClientPlugin, TwitterApiBasicAuth, TwitterApiOAuth2Init, TwitterApiTokens, TwitterRateLimit, TwitterResponse, UserV1, UserV2Result } from 'twitter-api-v2/dist/types';
...
import { SharedPromise } from 'twitter-api-v2/dist/helpers';
import type { TCustomizableRequestArgs, TRequestBody, TRequestQuery } from 'twitter-api-v2/dist/types/request-maker.mixin.types';
...
export default abstract class TwitterApiBase {
    ...
    getActiveTokens(): import("twitter-api-v2/dist/types").TClientTokens;
