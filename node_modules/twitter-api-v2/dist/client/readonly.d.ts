import TwitterApi from 'twitter-api-v2/dist/client';
import TwitterApiBase from 'twitter-api-v2/dist/client.base';
import { AccessOAuth2TokenArgs, AccessOAuth2TokenResult, BuildOAuth2RequestLinkArgs, IOAuth2RequestTokenResult, IParsedOAuth2TokenResult, LoginResult, RequestTokenArgs, Tweetv2SearchParams } from 'twitter-api-v2/dist/types';
import TwitterApiv1ReadOnly from 'twitter-api-v2/dist/v1/client.v1.read';
...
export default class TwitterApiReadOnly extends TwitterApiBase {
     ...
     */
    currentUser(forceFetch?: boolean): Promise<import("twitter-api-v2/dist/types").UserV1>;
    /**
     * Fetch and cache current user.
     ...
     */
    currentUserV2(forceFetch?: boolean): Promise<import("twitter-api-v2/dist/types").UserV2Result>;
